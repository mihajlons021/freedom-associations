...
function getUid() {
  try { let id = localStorage.getItem("_pgf"); if (!id) { id = "u" + Date.now().toString(36) + Math.random().toString(36).slice(2); localStorage.setItem("_pgf", id); } return id; } catch { return "u" + Math.random().toString(36).slice(2, 14); }
}
...
/* ═══ 12 BOARDS — no animals, no food cliches ═══ */
const BOARDS = [
  { columns:[
  ...
  { columns:[
    ...
    {id:"D",theme:"RIVERS",fields:[{id:"D1",clue:"Rome's river",answer:"TIBER"},{id:"D2",clue:"Vienna's blue river",answer:"DANUBE"},{id:"D3",clue:"Russia's longest",answer:"VOLGA"},{id:"D4",clue:"Amazon jungle",answer:"AMAZON"}]},
  ...
  { columns:[
    {id:"A",theme:"COCKTAILS",fields:[{id:"A1",clue:"James Bond's drink",answer:"MARTINI"},{id:"A2",clue:"Rum & mint leaves",answer:"MOJITO"},{id:"A3",clue:"Tequila & lime",answer:"MARGARITA"},{id:"A4",clue:"Coconut & rum",answer:"PINACOLADA"}]},
    {id:"B",theme:"ARTISTS",fields:[{id:"B1",clue:"Mona Lisa painter",answer:"DAVINCI"},{id:"B2",clue:"Sunflowers painter",answer:"VANGOGH"},{id:"B3",clue:"Cubism founder",answer:"PICASSO"},{id:"B4",clue:"Sistine chapel",answer:"MICHELANGELO"}]},
    ...
    {id:"D",theme:"WEATHER",fields:[{id:"D1",clue:"Funnel & twister",answer:"TORNADO"},{id:"D2",clue:"Lightning & thunder",answer:"STORM"},{id:"D3",clue:"Eye of the storm",answer:"HURRICANE"},{id:"D4",clue:"Blinding snowstorm",answer:"BLIZZARD"}]},
  ...
  { columns:[
    {id:"A",theme:"WINTER SPORTS",fields:[{id:"A1",clue:"Two planks downhill",answer:"SKIING"},{id:"A2",clue:"One board downhill",answer:"SNOWBOARD"},{id:"A3",clue:"Ice spinning jumps",answer:"SKATING"},{id:"A4",clue:"Broom on ice",answer:"CURLING"}]},
    {id:"B",theme:"FAMOUS BATTLES",fields:[{id:"B1",clue:"Napoleon's defeat",answer:"WATERLOO"},{id:"B2",clue:"Sparta 300",answer:"THERMOPYLAE"},{id:"B3",clue:"D-Day beaches",answer:"NORMANDY"},{id:"B4",clue:"Naval victory",answer:"TRAFALGAR"}]},
  ...
  { columns:[
    {id:"A",theme:"GREEK GODS",fields:[{id:"A1",clue:"King of gods",answer:"ZEUS"},{id:"A2",clue:"Sea god trident",answer:"POSEIDON"},{id:"A3",clue:"Underworld god",answer:"HADES"},{id:"A4",clue:"War god",answer:"ARES"}]},
    {id:"B",theme:"ELEMENTS",fields:[{id:"B1",clue:"Table number 1",answer:"HYDROGEN"},{id:"B2",clue:"Shiny metal jewelry",answer:"GOLD"},{id:"B3",clue:"We breathe it",answer:"OXYGEN"},{id:"B4",clue:"Diamond material",answer:"CARBON"}]},
    {id:"C",theme:"FASHION HOUSES",fields:[{id:"C1",clue:"French luxury CC",answer:"CHANEL"},{id:"C2",clue:"Italian LV bags",answer:"VUITTON"},{id:"C3",clue:"Italian Gucci",answer:"GUCCI"},{id:"C4",clue:"Italian Prada bags",answer:"PRADA"}]},
    {id:"D",theme:"BOARD GAMES",fields:[{id:"D1",clue:"32 pieces board",answer:"CHESS"},{id:"D2",clue:"Buy & rent property",answer:"MONOPOLY"},{id:"D3",clue:"Stack & topple",answer:"JENGA"},{id:"D4",clue:"Word on board",answer:"SCRABBLE"}]},
  ], final:{answer:"LEGACY",hint:"What you leave behind"} },
  { columns:[
    {id:"A",theme:"VOLCANOES",fields:[{id:"A1",clue:"Sicily fire mountain",answer:"ETNA"},{id:"A2",clue:"Pompeii destroyer",answer:"VESUVIUS"},{id:"A3",clue:"Hawaii's fire",answer:"KILAUEA"},{id:"A4",clue:"Indonesia's Krakatoa",answer:"KRAKATOA"}]},
    ...
    {id:"C",theme:"CLOUD TYPES",fields:[{id:"C1",clue:"Fluffy cotton balls",answer:"CUMULUS"},{id:"C2",clue:"Thin high streaks",answer:"CIRRUS"},{id:"C3",clue:"Gray rain layer",answer:"STRATUS"},{id:"C4",clue:"Storm tower",answer:"CUMULONIMBUS"}]},
    {id:"D",theme:"CRYPTO",fields:[{id:"D1",clue:"First crypto coin",answer:"BITCOIN"},{id:"D2",clue:"Smart contract",answer:"ETHEREUM"},{id:"D3",clue:"Meme dog coin",answer:"DOGECOIN"},{id:"D4",clue:"Project Freedom coin",answer:"FREEDOM"}]},
  ], final:{answer:"POWER",hint:"Force that shapes the world"} },
  { columns:[
    {id:"A",theme:"MEDIEVAL",fields:[{id:"A1",clue:"Armor wearer",answer:"KNIGHT"},{id:"A2",clue:"Fire breather",answer:"DRAGON"},{id:"A3",clue:"Magic caster",answer:"WIZARD"},{id:"A4",clue:"Stone fortress",answer:"CASTLE"}]},
  ...
  ], final:{answer:"CHALLENGE",hint:"Facing your fears"} },
  { columns:[
    {id:"A",theme:"RIVERS 2",fields:[{id:"A1",clue:"Egypt's lifeline",answer:"NILE"},{id:"A2",clue:"Through Paris",answer:"SEINE"},{id:"A3",clue:"China's sorrow",answer:"YANGTZE"},{id:"A4",clue:"India's sacred",answer:"GANGES"}]},
    {id:"B",theme:"MINERALS",fields:[{id:"B1",clue:"Pink quartz love",answer:"ROSEQUARTZ"},{id:"B2",clue:"Purple crystal",answer:"AMETHYST"},{id:"B3",clue:"Black obsidian blade",answer:"OBSIDIAN"},{id:"B4",clue:"Green malachite",answer:"MALACHITE"}]},
    {id:"C",theme:"FAMOUS QUOTES",fields:[{id:"C1",clue:"To be or not to be",answer:"SHAKESPEARE"},{id:"C2",clue:"I think therefore I am",answer:"DESCARTES"},{id:"C3",clue:"Cogito ergo sum",answer:"DESCARTES"},{id:"C4",clue:"Elementary my dear",answer:"HOLMES"}]},
    {id:"D",theme:"DRINKS",fields:[{id:"D1",clue:"Morning espresso",answer:"COFFEE"},{id:"D2",clue:"Aged Scottish",answer:"WHISKY"},{id:"D3",clue:"German Oktober",answer:"BEER"},{id:"D4",clue:"French sparkling",answer:"CHAMPAGNE"}]},
  ], final:{answer:"CLASSIC",hint:"Timeless and enduring"} },
];

function pickBoard() {
  try {
    let seen = JSON.parse(localStorage.getItem("_seen") || "[]");
    const avail = BOARDS.map((_,i)=>i).filter(i=>!seen.includes(i));
    const pool = avail.length > 0 ? avail : BOARDS.map((_,i)=>i);
    const idx = pool[Math.floor(Math.random() * pool.length)];
    seen = [idx, ...seen].slice(0, 5);
    localStorage.setItem("_seen", JSON.stringify(seen));
...
async function signW(n){try{if(!window.solana?.isPhantom)return{ok:false,err:"No Phantom"};await window.solana.signMessage(new TextEncoder().encode("Wager "+n+" FREEDOM"),"utf8");return{ok:true,id:"SIG_"+Date.now()};}catch(e){return{ok:false,err:e.message};}}

/* ══════════════════════════════════════════════
   MOBILE FIELD — same as before, works great
══════════════════════════════════════════════ */
function MField({field, st, solvedBy, canOpen, onOpen}) {
  const bg = st==="solved"?(solvedBy==="p1"?PC1:PC2):st==="clue"?"#c47d0e":canOpen?"#2d5a8a":"#1e3a5a";
  const s = {width:"100%",height:54,borderRadius:10,display:"flex",alignItems:"center",justifyContent:"center",flexDirection:"column",gap:2,padding:"0 8px",boxSizing:"border-box",background:bg,border:st==="clue"?"2px solid #f59e0b":st==="solved"?"none":canOpen?"1px solid #3a6a9a":"1px solid #1a2a3a",boxShadow:canOpen&&st==="hidden"?"0 3px 6px rgba(0,0,0,.5)":st==="solved"?"0 3px 0 rgba(0,0,0,.4)":"none",cursor:canOpen&&st==="hidden"?"pointer":"default",transition:"all .15s",userSelect:"none"};
  if(st==="solved")return<div style={s}><div style={{fontSize:13,fontWeight:900,color:"#fff",textAlign:"center"}}>{field.answer}</div><div style={{fontSize:9,color:"rgba(255,255,255,.7)",textAlign:"center"}}>{field.clue}</div></div>;
  if(st==="clue")return<div style={s}><div style={{fontSize:12,color:"#fff",fontWeight:700,textAlign:"center",lineHeight:1.2}}>{field.clue}</div></div>;
  return<div onClick={canOpen?()=>onOpen(field.id):undefined} style={s} onMouseEnter={e=>{if(canOpen)e.currentTarget.style.background="#3a6e9e";}} onMouseLeave={e=>{if(canOpen)e.currentTarget.style.background="#2d5a8a";}}><span style={{fontSize:14,fontWeight:900,color:canOpen?"#7ab8e0":"#1a2a3a",letterSpacing:1}}>{field.id}</span></div>;
}

/* ══════════════════════════════════════════════
   DESKTOP FIELD — fixed height, bright colors
══════════════════════════════════════════════ */
function DField({field, st, solvedBy, canOpen, onOpen, h}) {
  const bg = st==="solved"?(solvedBy==="p1"?PC1:PC2):st==="clue"?"#c47d0e":canOpen?"#2d5a8a":"#1e3a5a";
  const s = {width:"100%",height:h,borderRadius:8,display:"flex",alignItems:"center",justifyContent:"center",flexDirection:"column",gap:2,padding:"0 8px",boxSizing:"border-box",background:bg,border:st==="clue"?"2px solid #f59e0b":st==="solved"?"none":canOpen?"1px solid #3a6a9a":"1px solid #1a2a3a",boxShadow:canOpen&&st==="hidden"?"0 3px 8px rgba(0,0,0,.5)":st==="solved"?"0 3px 0 rgba(0,0,0,.4)":"none",cursor:canOpen&&st==="hidden"?"pointer":"default",transition:"all .15s",userSelect:"none"};
  if(st==="solved")return<div style={s}><div style={{fontSize:"clamp(10px,1.1vw,15px)",fontWeight:900,color:"#fff",textAlign:"center",letterSpacing:.5}}>{field.answer}</div><div style={{fontSize:"clamp(7px,.8vw,10px)",color:"rgba(255,255,255,.75)",textAlign:"center"}}>{field.clue}</div></div>;
  ...
  return<div onClick={canOpen?()=>onOpen(field.id):undefined} style={s} onMouseEnter={e=>{if(canOpen){e.currentTarget.style.background="#3a6e9e";e.currentTarget.style.boxShadow="0 4px 12px rgba(0,0,0,.6)";}}} onMouseLeave={e=>{if(canOpen){e.currentTarget.style.background="#2d5a8a";e.currentTarget.style.boxShadow="0 3px 8px rgba(0,0,0,.5)";}}}><span style={{fontSize:"clamp(11px,1.2vw,18px)",fontWeight:900,color:canOpen?"#7ab8e0":"#1a2a3a",letterSpacing:1}}>{field.id}</span></div>;
}
...
function TInput({cid, solved, solvedBy, theme, disabled, onGuess, h}) {
  ...
  if(solved)return<div style={{width:"100%",height:h,borderRadius:8,display:"flex",alignItems:"center",justifyContent:"center",background:sc,boxShadow:"0 3px 0 rgba(0,0,0,.4)"}}><span style={{fontSize:"clamp(9px,.9vw,12px)",fontWeight:900,color:"#fff",textAlign:"center",padding:"0 4px"}}>✓ {theme}</span></div>;
  ...
  return<div onClick={disabled?undefined:()=>setEd(true)} style={{width:"100%",height:h,borderRadius:8,display:"flex",alignItems:"center",justifyContent:"center",background:disabled?"#111c2a":"rgba(45,90,138,.35)",border:"2px dashed "+(disabled?"#1a2a3a":"#5b9bd5"),cursor:disabled?"default":"pointer",transition:"all .15s"}} onMouseEnter={e=>{if(!disabled)e.currentTarget.style.background="rgba(45,90,138,.55)";}} onMouseLeave={e=>{if(!disabled)e.currentTarget.style.background="rgba(45,90,138,.35)";}}><span style={{fontSize:22,color:disabled?"#1a2a3a":"#7ab8e0",fontWeight:900}}>?</span></div>;
}
...
function FInput({solved, solvedBy, answer, disabled, onGuess, h}) {
  ...
  return<div onClick={disabled?undefined:()=>setEd(true)} style={{width:"100%",height:h,borderRadius:10,display:"flex",alignItems:"center",justifyContent:"center",background:disabled?"#111c2a":"rgba(245,158,11,.15)",border:"3px dashed "+(disabled?"#1a2a3a":"#f59e0b"),cursor:disabled?"default":"pointer",transition:"all .15s"}} onMouseEnter={e=>{if(!disabled)e.currentTarget.style.background="rgba(245,158,11,.3)";}} onMouseLeave={e=>{if(!disabled)e.currentTarget.style.background="rgba(245,158,11,.15)";}}><span style={{fontSize:26,color:disabled?"#1a2a3a":"#f59e0b",fontWeight:900}}>?</span></div>;
}
...
export default function App(){
  ...
  async function doGuessFinal(val){touch();if(match(val,gs.board.final.answer)){await update(rRef.current,{finalSolved:myRole,["scores/"+myRole]:(gs.scores?.[myRole]||0)+30,lastActivity:Date.now()});doEnd(myRole,"Final correct! +30pts 🎉");return true;}L("❌ Wrong final. Opponent's turn!");await doPass();return false;}
  ...
  if(scr==="waiting")return(
    <div style={ROOT}><style>{CSS}</style>
      <div style={{flex:1,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",gap:14,padding:20}}>
        ...
        <div style={{textAlign:"center"}}><div style={{fontSize:12,color:"rgba(255,255,255,.5)",marginBottom:8}}>SHARE ROOM ID:</div><div style={{fontSize:42,fontFamily:"'Black Ops One',cursive",color:"#22c55e",letterSpacing:10,padding:"14px 28px",background:"rgba(34,197,94,.1)",border:"2px solid rgba(34,197,94,.4)",borderRadius:12}}>{roomId}</div><div style={{fontSize:10,color:"rgba(255,255,255,.3)",marginTop:8}}>Opponent → JOIN ROOM → enter this code</div></div>
  ...
  const SB=(
    <div style={{background:"#0a1628",padding:"7px 14px",borderBottom:"2px solid #f59e0b",flexShrink:0}}>
      <div style={{display:"flex",alignItems:"center",gap:8}}>
        <div style={{flex:1,display:"flex",alignItems:"center",gap:8}}><div style={{width:36,height:36,borderRadius:"50%",background:PC1,display:"flex",alignItems:"center",justifyContent:"center",fontFamily:"'Black Ops One',cursive",fontSize:12,color:"#fff",flexShrink:0,boxShadow:"0 2px 0 rgba(0,0,0,.3)"}}>{myNm.slice(0,2).toUpperCase()}</div><div><div style={{fontSize:10,color:"rgba(255,255,255,.5)"}}>{myNm}</div><div style={{fontSize:22,fontWeight:900,color:"#fff",lineHeight:1}}>{myScore}</div></div></div>
        <div style={{display:"flex",flexDirection:"column",alignItems:"center",gap:1,minWidth:60}}>
          <div style={{width:48,height:48,borderRadius:"50%",background:"#060e1c",border:"3px solid "+(!started?"#1a3450":finalPhase?(it<10?"#ef4444":"#f59e0b"):isMy?"#22c55e":"#1a3450"),display:"flex",alignItems:"center",justifyContent:"center"}}><span style={{fontFamily:"'Black Ops One',cursive",fontSize:15,fontWeight:900,color:!started?"#1a3450":finalPhase?"#f59e0b":isMy?"#22c55e":"#1a3450"}}>{!started?"⏳":finalPhase&&isMy?it:!finalPhase&&isMy?tt:"·"}</span></div>
        ...
        <div style={{flex:1,display:"flex",alignItems:"center",gap:8,justifyContent:"flex-end"}}><div style={{textAlign:"right"}}><div style={{fontSize:10,color:"rgba(255,255,255,.5)"}}>{opNm}</div><div style={{fontSize:22,fontWeight:900,color:"#fff",lineHeight:1}}>{opScore}</div></div><div style={{width:36,height:36,borderRadius:"50%",background:PC2,display:"flex",alignItems:"center",justifyContent:"center",fontFamily:"'Black Ops One',cursive",fontSize:12,color:"#fff",flexShrink:0,boxShadow:"0 2px 0 rgba(0,0,0,.3)"}}>{opNm.slice(0,2).toUpperCase()}</div></div>
      </div>
      <div style={{textAlign:"center",marginTop:4,fontSize:10,color:isMy&&started?"#f59e0b":"rgba(255,255,255,.3)",fontWeight:700}}>{!started?"⏳ Waiting...":finalPhase?(isMy?"🎯 TAP ? TO GUESS":"⏳ OPPONENT..."):isMy?(canOpen?"👆 TAP A FIELD TO REVEAL":canGuess?"💡 TAP ? TO GUESS":"..."):"⏳ OPPONENT'S TURN"}</div>
    </div>
  );

  const PL=(<div style={{display:"flex",gap:8,alignItems:"flex-start",marginTop:6}}>{isMy&&!finalPhase&&didOpen&&started&&<button onClick={()=>{touch();doPass();L("Passed.");}} style={{padding:"8px 14px",background:"rgba(255,255,255,.08)",color:"rgba(255,255,255,.6)",border:"1px solid rgba(255,255,255,.15)",borderRadius:8,fontFamily:"inherit",fontSize:10,fontWeight:700,cursor:"pointer",flexShrink:0}}>PASS</button>}{log.length>0&&<div style={{flex:1,padding:"5px 9px",background:"rgba(0,0,0,.3)",borderRadius:8}}>{log.map((l,i)=><div key={i} style={{fontSize:10,color:i===0?"rgba(255,255,255,.8)":"rgba(255,255,255,.3)",padding:"1px 0"}}>{l}</div>)}</div>}</div>);

  /* ══════════════════════════════════════════════════
     DESKTOP — completely new approach
     
     Instead of fighting with 1fr and CSS grid heights,
     I calculate exact pixel heights based on window size.
     
     fieldH = (windowH - scoreboard - padding - final - footer) / 2
     
     This always works, always fills the screen.
  ══════════════════════════════════════════════════ */
  if(desktop){
    const WH = window.innerHeight;
    const SBARS = 98;   // scoreboard height
    const PAD = 20;     // top+bottom padding
    const FINAL = 60;   // final input height
    const FOOTER = 40;  // pass/log + footer
    const GAPS = 8;     // gap between rows
    const fieldH = Math.floor((WH - SBARS - PAD - FINAL - FOOTER - GAPS) / 2);
    const G = 8;

    return(
      <div style={ROOT}><style>{CSS}</style>
      {SB}
      <div style={{flex:1,padding:"10px 16px",display:"flex",flexDirection:"column",gap:G,overflow:"hidden"}}>

        {/* ROW 1: [A] [A4 A3 A2 A1] [ThemeA] [FINAL] [ThemeB] [B1 B2 B3 B4] [B] */}
        <div style={{display:"flex",gap:G,alignItems:"stretch",height:fieldH,flexShrink:0}}>
          {/* A label */}
          <div style={{width:28,display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0}}>
            <span style={{fontFamily:"'Black Ops One',cursive",fontSize:26,color:PC1,textShadow:"0 0 12px "+PC1+"66"}}>A</span>
          </div>
          {/* A fields */}
          <div style={{flex:1,display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:G}}>
            {[...colA.fields].reverse().map(f=>{const{st,solvedBy}=fst(f.id);return<DField key={f.id} field={f} st={st} solvedBy={solvedBy} canOpen={canOpen&&st==="hidden"} onOpen={doOpen} h={fieldH}/>;}) }
          </div>
          {/* Theme A */}
          <div style={{width:110,flexShrink:0}}>
            <TInput cid="A" solved={!!colSolved.A} solvedBy={colSolved.A} theme={colA.theme} disabled={!canGuess} onGuess={v=>doGuessCol("A",v)} h={fieldH}/>
          </div>
          {/* FINAL BOX spanning both rows — use absolute positioning trick */}
          <div style={{width:120,flexShrink:0,height:fieldH*2+G,marginTop:0,position:"relative"}}>
            <div style={{position:"absolute",top:0,left:0,right:0,height:fieldH*2+G,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",background:finalPhase?"rgba(245,158,11,.1)":"#060e1c",border:"2px solid "+(finalPhase?"#f59e0b88":"#1a2a3a"),borderRadius:14,textAlign:"center",animation:finalPhase?"glowPulse 2s infinite":"none",padding:10}}>
              <div style={{fontSize:8,color:"#2a4060",letterSpacing:2,marginBottom:8}}>FINAL ANSWER</div>
              {finalSolved?<div style={{fontSize:13,fontWeight:900,color:finalSolved==="p1"?PC1:PC2}}>{board.final.answer}</div>:<div style={{fontSize:26,color:"#1a2a3a",fontWeight:900,fontFamily:"'Black Ops One',cursive",lineHeight:1}}>???</div>}
              <div style={{fontSize:8,color:"#1a2a3a",marginTop:8,fontStyle:"italic"}}>{board.final.hint}</div>
            </div>
          </div>
          {/* Theme B */}
          <div style={{width:110,flexShrink:0}}>
            <TInput cid="B" solved={!!colSolved.B} solvedBy={colSolved.B} theme={colB.theme} disabled={!canGuess} onGuess={v=>doGuessCol("B",v)} h={fieldH}/>
          </div>
          {/* B fields */}
          <div style={{flex:1,display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:G}}>
            {colB.fields.map(f=>{const{st,solvedBy}=fst(f.id);return<DField key={f.id} field={f} st={st} solvedBy={solvedBy} canOpen={canOpen&&st==="hidden"} onOpen={doOpen} h={fieldH}/>;}) }
          </div>
          {/* B label */}
          <div style={{width:28,display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0}}>
            <span style={{fontFamily:"'Black Ops One',cursive",fontSize:26,color:PC2,textShadow:"0 0 12px "+PC2+"66"}}>B</span>
          </div>
        </div>

        {/* ROW 2: [C] [C4 C3 C2 C1] [ThemeC] [spacer for FINAL] [ThemeD] [D1 D2 D3 D4] [D] */}
        <div style={{display:"flex",gap:G,alignItems:"stretch",height:fieldH,flexShrink:0}}>
          {/* C label */}
          <div style={{width:28,display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0}}>
            <span style={{fontFamily:"'Black Ops One',cursive",fontSize:26,color:PC1,textShadow:"0 0 12px "+PC1+"66"}}>C</span>
          </div>
          {/* C fields */}
          <div style={{flex:1,display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:G}}>
            {[...colC.fields].reverse().map(f=>{const{st,solvedBy}=fst(f.id);return<DField key={f.id} field={f} st={st} solvedBy={solvedBy} canOpen={canOpen&&st==="hidden"} onOpen={doOpen} h={fieldH}/>;}) }
          </div>
          {/* Theme C */}
          <div style={{width:110,flexShrink:0}}>
            <TInput cid="C" solved={!!colSolved.C} solvedBy={colSolved.C} theme={colC.theme} disabled={!canGuess} onGuess={v=>doGuessCol("C",v)} h={fieldH}/>
          </div>
          {/* Spacer where FINAL overlaps */}
          <div style={{width:120,flexShrink:0}}/>
          {/* Theme D */}
          <div style={{width:110,flexShrink:0}}>
            <TInput cid="D" solved={!!colSolved.D} solvedBy={colSolved.D} theme={colD.theme} disabled={!canGuess} onGuess={v=>doGuessCol("D",v)} h={fieldH}/>
          </div>
          {/* D fields */}
          <div style={{flex:1,display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:G}}>
            {colD.fields.map(f=>{const{st,solvedBy}=fst(f.id);return<DField key={f.id} field={f} st={st} solvedBy={solvedBy} canOpen={canOpen&&st==="hidden"} onOpen={doOpen} h={fieldH}/>;}) }
          </div>
          {/* D label */}
          <div style={{width:28,display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0}}>
            <span style={{fontFamily:"'Black Ops One',cursive",fontSize:26,color:PC2,textShadow:"0 0 12px "+PC2+"66"}}>D</span>
          </div>
        </div>
        ...
        {PL}
        <div style={{textAlign:"center",padding:"2px 0"}}><span style={{fontFamily:"'Black Ops One',cursive",fontSize:10,letterSpacing:2}}><span style={{color:"#8b5cf6"}}>DEGEN</span><span style={{color:"#22c55e"}}>SAFE</span><span style={{color:"rgba(255,255,255,.3)"}}>.FUN</span></span></div>
      </div>
      </div>
    );
  }

  /* ── MOBILE — unchanged, works great ── */
  return(
    <div style={ROOT}><style>{CSS}</style>
    {SB}
    <div style={{flex:1,overflowY:"auto",padding:"7px 10px"}}>
      <div style={{maxWidth:500,margin:"0 auto",display:"flex",flexDirection:"column",gap:5}}>
        ...
        {[0,1,2,3].map(i=><div key={i} style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:6}}>{[colA.fields[i],colB.fields[i]].map(f=>{const{st,solvedBy}=fst(f.id);return<MField key={f.id} field={f} st={st} solvedBy={solvedBy} canOpen={canOpen&&st==="hidden"} onOpen={doOpen}/>;})}</div>)}
        <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:6}}>
        ...
        {[0,1,2,3].map(i=><div key={i} style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:6}}>{[colC.fields[i],colD.fields[i]].map(f=>{const{st,solvedBy}=fst(f.id);return<MField key={f.id} field={f} st={st} solvedBy={solvedBy} canOpen={canOpen&&st==="hidden"} onOpen={doOpen}/>;})}</div>)}
        <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:6}}>
          <div style={{textAlign:"center",paddingTop:2,borderTop:"3px solid "+PC1}}><span style={{fontFamily:"'Black Ops One',cursive",fontSize:16,color:PC1,letterSpacing:3}}>C</span></div>
          <div style={{textAlign:"center",paddingTop:2,borderTop:"3px solid "+PC2}}><span style={{fontFamily:"'Black Ops One',cursive",fontSize:16,color:PC2,letterSpacing:3}}>D</span></div>
        </div>
        {PL}
